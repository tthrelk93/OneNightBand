...
class SendAuditionViewController: UIViewController, UITextViewDelegate, Dismissable {
    ...
    @IBAction func auditionButtonPressed(_ sender: Any) {
        ...
        let wantedRef = FIRDatabase.database().reference().child("wantedAds").child(wantedAd.wantedID)
    ...
    override func viewDidLoad() {
        ...
        auditInfoTextView1.textColor = UIColor.lightGray
        auditInfoTextView2.textColor = UIColor.lightGray
