...
class MP3Player: NSObject{
    ...
    init(urlArray: [String], mp3Names: [String], sessionID: String){
        ...
        super.init()
        //urlArray.first as FIRStorageReference
    ...
    func queueTrack(){
        ...
        //var error:NSError?
        let songRef = FIRStorage.storage().reference(withPath: "session_audio").child(sessionID).child(String(describing: localURLs[currentTrackIndex]))
